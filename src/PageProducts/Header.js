...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className={`search-popup ${searchVisible ? 'is-visible' : ''}`}>
        <div className="search-popup-container">
          <form role="search" method="get" className="search-form" onSubmit={(e) => { e.preventDefault(); window.location.href = `/search/${search}`; }}>
            ...
            <button type="submit" className="search-submit"><svg className="search"><use xlinkHref="#search" /></svg></button>
          </form>
        ...
        <nav id="header-nav" className="navbar navbar-expand-lg px-3 mb-3">
          <div className="container-fluid">
            <Link className="navbar-brand" to="/">
              <img src={logo} className="logo" alt="WiredWave Logo" />
            </Link>
                ...
                <ul id="navbar" className="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                    ...
                    <div className="user-items ps-5">
                      <ul className="d-flex justify-content-end list-unstyled">
                        <li className="search-item pe-3">
                          <button onClick={() => setSearchVisible(!searchVisible)} className="search-button" type="button">
                  ...
                  <li className="nav-item dropdown ms-sm-0 ms-lg-2">
                    <Link className="nav-link me-4 dropdown-toggle link-dark rounded-circle" data-bs-toggle="dropdown" to="#" role="button" aria-expanded="false">
                      <img src={login[0].image} width={"30px"} height={"32px"} className='rounded-circle' alt="User Avatar" /><span className='h1 p-2 d-sm-inline d-lg-none'>{login[0].username}</span></Link>
                    <ul className="dropdown-menu">
                      <li>
                        <Link to="/profile" className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
                          <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                        </svg> Profile</Link>
                      </li>
                      <li>
                        <Link to="/products#mobile-products" className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-shop" viewBox="0 0 16 16">
                      ...
                      <li>
                        <Link to="/cart" className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
                          <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2" />
                        </svg> Cart</Link>
                      </li>
                      <li>
                      </li><li>
                        <Link onClick={logout} className="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-right mt-0" viewBox="0 0 16 16">
